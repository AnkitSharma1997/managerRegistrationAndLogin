...
<div style="margin-top:15%;margin-left:40%;">
  <h1>Manager Login</h1>
 <form action ="managerView" method = "post" modelAttribute = "model" name="RegForm" onsubmit = "return validation()">
  ...
  <a href="managerReg" style="margin-left:100px;margin-top:30px;">Sign Up</a>
</div>
  </body>
</html>