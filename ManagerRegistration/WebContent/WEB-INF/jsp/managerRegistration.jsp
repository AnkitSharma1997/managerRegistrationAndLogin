...
<form action="managerReg.html" modelAttribute="model" method = "post" name="RegForm" onsubmit = "return validation()">
...
<input type="text" placeholder="Password" name = "manager_password" style="border-radius : 5px; height:25px;" />  <span id = "p" style="color:red;"></span><br><br>
